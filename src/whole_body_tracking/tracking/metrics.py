"""Tracking evaluation metrics aligned with mjlab tracking semantics."""
...
def compute_mpkpe(command: "MotionSourceCommand") -> torch.Tensor:
    """Compute mean per-keybody position error in world frame."""
...
def compute_root_relative_mpkpe(command: "MotionSourceCommand") -> torch.Tensor:
    """Compute root-relative mean per-keybody position error."""
...
def compute_joint_velocity_error(command: "MotionSourceCommand") -> torch.Tensor:
